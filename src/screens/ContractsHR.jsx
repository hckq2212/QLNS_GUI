        ...
        <div className="space-y-3">
          {contracts.map((c) => (
            <div key={c.id} className="p-4 border rounded">
              ...
              <div className="text-sm text-gray-700">Customer: {c.customer?.name || customerCache[c.customer_id]?.name || c.customer_name || c.customer_temp.name || c.customer_temp || 'Unknown'}</div>
